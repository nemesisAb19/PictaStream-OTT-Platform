...
import './Apurva.css'; // Assuming you'll create a separate CSS for styling
import VideoPlayer from './VideoPlayer';
import ApurvaTrailerVideoPlayer from './ApurvaTrailerVideoPlayer'; 
...
const NextArrow = (props) => {
  const { onClick } = props;
  return (
    <div className="apurva-titles-you-might-like-custom-arrow next" onClick={onClick}>
...
const PrevArrow = (props) => {
  const { onClick } = props;
  return (
    <div className="apurva-titles-you-might-like-custom-arrow prev" onClick={onClick}>
...
const Apurva = () => {
  ...
  const handlePlayTrailer = () => {
    setVideoUrl('/videos/apurva.mp4'); // Set the trailer video URL here
  ...
  const handleWatchNow = () => {
    setVideoUrl('/Videos/apurva.mp4'); // Set the movie video URL here
    setVideoPlayerVisible(true);
  };
  ...
  const cast = [
    { name: 'Tara Sutaria', image: '/images/Images/TaraSutaria.jpg' },
    { name: 'Dhairya Karwa', image: '/images/Images/DhairyaKarwa' },
    { name: 'Abhishek Banerjee', image: '/images/Images/AbhishekBanerjee.jpg' },
    { name: 'Rajpal Yadav', image: '/images/Images/Rajpal-Yadav.jpg' },
    { name: 'Sumit Gulati', image: '/images/Images/SumitGulati.jpg' },
    { name: 'Navni Parihar', image: '/images/Images/NavniParihar.jpg' },
  ];

  return (
    <div className="apurva-page">
    ...
    {!isVideoPlayerVisible ? (
      ...
      <section className="apurva-banner">
        <div className="banner-image">
          <img 
            src="/images/Images/BannerApurva" 
            alt="Apurva" 
            className="banner-image" 
          />
        </div>
        <div className="movie-details">
          <h1 className="movie-title">Apurva</h1>
          <p className="movie-meta">2023 • 2h 10min • Hindi • U/A</p>
          <p className="movie-description">
            Apurva is a gripping drama about resilience and courage, set against the backdrop of real-life challenges.
          </p>
          <p className="genres">Genres: Action, Drama, Thriller</p>
      ...
      <section className="apurva-titles-you-might-like-section">
      ...
      {/* Trailer Section */}
      <section className="apurva-trailer-section">
        <div className="section-header">
          <h2>Watch The Trailer</h2>
        </div>
        <div className="trailer-card" onClick={handlePlayTrailer}>
          <img src="/images/Images/Apurva.jfif" alt="Apurva Trailer" className="trailer-image" />
      ...
      {/* Video Player */}
      {isVideoPlayerVisible && <ApurvaTrailerVideoPlayer videoUrl={videoUrl} onBack={handleBackTrailer} />}

      </>

    ) : (
      <VideoPlayer videoUrl="/path/to/video.mp4" onBack={handleBack} />
      )}
