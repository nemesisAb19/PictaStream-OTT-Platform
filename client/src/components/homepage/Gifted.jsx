...
import './Gifted.css'; // Assuming you'll create a separate CSS for styling
import Slider from 'react-slick';
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import GiftedVideoPlayer from './GiftedVideoPlayer';
import GiftedTrailerVideoPlayer from './GiftedTrailerVideoPlayer';

// Custom Next Arrow component
const NextArrow = (props) => {
  const { onClick } = props;
  return (
    <div className="gifted-titles-you-might-like-custom-arrow next" onClick={onClick}>
...
const PrevArrow = (props) => {
  const { onClick } = props;
  return (
    <div className="gifted-titles-you-might-like-custom-arrow prev" onClick={onClick}>
...
const Gifted = () => {
  ...
  const handlePlayTrailer = () => {
    setVideoUrl('/videos/gifted.mp4'); // Set the trailer video URL here
  ...
  const handleWatchNow = () => {
    setVideoUrl('/Videos/gifted.mp4'); // Set the movie video URL here
    setVideoPlayerVisible(true);
  };
  ...
  return (
    ...
    {!isVideoPlayerVisible ? (
      ...
      <section className="gifetd-banner">
        <div className="banner-image">
          <img 
            src="/Images/BannerGifted.jpg" 
            alt="Gifted" 
            className="banner-image" 
          />
        </div>
        <div className="movie-details">
          <h1 className="movie-title">Gifted</h1>
          <p className="movie-meta">2017 • 1h 41min • English • U/A 13+</p>
          ...
          <p className="genres">Genres: Drama, Family</p>
      ...
      <section className="gifted-titles-you-might-like-section">
      ...
      {/* Trailer Section */}
      <section className="gifted-trailer-section">
        <div className="section-header">
          <h2>Watch The Trailer</h2>
        </div>
        <div className="gifted-trailer-card" onClick={handlePlayTrailer}>
          <img src="/Images/trailer_gifted.jpg" alt="gifted Trailer" className="trailer-image" />
      ...
      {/* Video Player */}
      {isVideoPlayerVisible && <GiftedTrailerVideoPlayer videoUrl={videoUrl} onBack={handleBackTrailer} />}

      </>
    ) : (
      <GiftedVideoPlayer videoUrl="/path/to/video.mp4" onBack={handleBack} />
      )}
