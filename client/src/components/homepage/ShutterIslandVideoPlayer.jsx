...
import './ShutterIslandVideoPlayer.css'; // Create this CSS file for styling

const ShutterIslandVideoPlayer = ({ videoUrl, onBack }) => {
  ...
  return (
    <div className="shutterIsland-video-player">
      <video ref={videoRef} src={"/Videos/shutterIsland.mp4"} controls className="shutterIsland-video-element">
...
export default ShutterIslandVideoPlayer;
