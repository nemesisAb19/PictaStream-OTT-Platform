...
import './GiftedVideoPlayer.css'; // Create this CSS file for styling

const GiftedVideoPlayer = ({ videoUrl, onBack }) => {
  ...
  return (
    <div className="gifted-video-player">
      <video ref={videoRef} src={"/Videos/gifted.mp4"} controls className="gifted-video-element">
...
export default GiftedVideoPlayer;
