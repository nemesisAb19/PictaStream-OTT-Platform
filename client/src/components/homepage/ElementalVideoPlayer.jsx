...
import './ElementalVideoPlayer.css'; // Create this CSS file for styling

const ElementalVideoPlayer = ({ videoUrl, onBack }) => {
  ...
  return (
    <div className="elemental-video-player">
      <video ref={videoRef} src={"/Videos/elemental.mp4"} controls className="elemental-video-element">
...
export default ElementalVideoPlayer;