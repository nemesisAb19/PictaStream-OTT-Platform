...
import './LaxmiiVideoPlayer.css'; // Create this CSS file for styling

const LaxmiiVideoPlayer = ({ videoUrl, onBack }) => {
  ...
  return (
    <div className="laxmii-video-player">
      <video ref={videoRef} src={"/Videos/laxmii.mp4"} controls className="laxmii-video-element">
...
export default LaxmiiVideoPlayer;
