...
import './October.css'; // Assuming you'll create a separate CSS for styling
import Slider from 'react-slick';
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import OctoberVideoPlayer from './OctoberVideoPlayer';
import OctoberTrailerVideoPlayer from './OctoberTrailerVideoPlayer';

// Custom Next Arrow component
const NextArrow = (props) => {
  const { onClick } = props;
  return (
    <div className="october-titles-you-might-like-custom-arrow next" onClick={onClick}>
...
const PrevArrow = (props) => {
  const { onClick } = props;
  return (
    <div className="october-titles-you-might-like-custom-arrow prev" onClick={onClick}>
...
const October = () => {
  ...
  const handlePlayTrailer = () => {
    setVideoUrl('/videos/october.mp4'); // Set the trailer video URL here
  ...
  const handleWatchNow = () => {
    setVideoUrl('/Videos/october.mp4'); // Set the movie video URL here
    setVideoPlayerVisible(true);
  };
  ...
  return (
    ...
    {!isVideoPlayerVisible ? (
      ...
      <section className="october-banner">
        <div className="banner-image">
          <img 
            src="/Images/BannerOctober.jpg" 
            alt="October" 
            className="banner-image" 
          />
        </div>
        <div className="movie-details">
          <h1 className="movie-title">October</h1>
          <p className="movie-meta">2018 • 1h 55min • Hindi • U</p>
          ...
          <p className="genres">Genres: Drama, Romance, Passionate</p>
      ...
      <section className="october-titles-you-might-like-section">
      ...
      {/* Trailer Section */}
      <section className="october-trailer-section">
        <div className="section-header">
          <h2>Watch The Trailer</h2>
        </div>
        <div className="october-trailer-card" onClick={handlePlayTrailer}>
          <img src="/Images/trailer_october.png" alt="gifted Trailer" className="trailer-image" />
      ...
      {/* Video Player */}
      {isVideoPlayerVisible && <OctoberTrailerVideoPlayer videoUrl={videoUrl} onBack={handleBackTrailer} />}

      </>
    ) : (
      <OctoberVideoPlayer videoUrl="/path/to/video.mp4" onBack={handleBack} />
      )}
