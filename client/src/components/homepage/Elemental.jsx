...
import './Elemental.css'; // Assuming you'll create a separate CSS for styling
import Slider from 'react-slick';
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import ElementalVideoPlayer from './ElementalVideoPlayer';
import ElementalTrailerVideoPlayer from './ElementalTrailerVideoPlayer';

// Custom Next Arrow component
const NextArrow = (props) => {
  const { onClick } = props;
  return (
    <div className="elemental-titles-you-might-like-custom-arrow next" onClick={onClick}>
...
const PrevArrow = (props) => {
  const { onClick } = props;
  return (
    <div className="elemental-titles-you-might-like-custom-arrow prev" onClick={onClick}>
...
const Elemental = () => {
  ...
  const handlePlayTrailer = () => {
    setVideoUrl('/videos/elemental.mp4'); // Set the trailer video URL here
  ...
  const handleWatchNow = () => {
    setVideoUrl('/Videos/elemental.mp4'); // Set the movie video URL here
    setVideoPlayerVisible(true);
  };
  ...
  const titlesYouMightLikeOnPicta = [
   ...
   const cast = [
    { name: 'Leah Lewis', image: '/images/Images/LeahLewis.jpg' },
    { name: 'Mamoudou Athie', image: '/images/Images/MamoudouAthie.jpg' },
    { name: 'Adèle Exarchopoulos', image: '/images/Images/Adele.jpg' },
    { name: 'Mason Wertheimer', image: '/images/Images/MasonWertheimer.jpg' },
    { name: 'Alex Kapp', image: '/images/Images/AlexKapp.jpg' },
    { name: 'Reagan To', image: '/images/Images/ReaganTo.jpg' },
  ];

  return (
    <div className="elemental-page">
    ...
    {!isVideoPlayerVisible ? (
      ...
      <section className="elemental-banner">
        <div className="banner-image">
          <img 
            src="/images/Images/BannerElemental" 
            alt="Elemental" 
            className="banner-image" 
          />
        </div>
        <div className="movie-details">
          <h1 className="movie-title">Elemental</h1>
          <p className="movie-meta">2023 • 1h 41min • English • U/A 7+</p>
          <p className="movie-description">
            Fiery Ember is tested when she meets go-with-the-flow Wade in Element City.
          </p>
          <p className="genres">Genres: Comedy, Fantasy, Family</p>
      ...
      <section className="elemental-titles-you-might-like-section">
      ...
      {/* Trailer Section */}
      <section className="elemental-trailer-section">
        <div className="section-header">
          <h2>Watch The Trailer</h2>
        </div>
        <div className="elemental-trailer-card" onClick={handlePlayTrailer}>
          <img src="/images/Images/Elemental.jpg" alt="Elemental Trailer" className="trailer-image" />
      ...
      {/* Video Player */}
      {isVideoPlayerVisible && <ElementalTrailerVideoPlayer videoUrl={videoUrl} onBack={handleBackTrailer} />}

      </>

    ) : (
      <ElementalVideoPlayer videoUrl="/path/to/video.mp4" onBack={handleBack} />
      )}
