...
import './TheIncrediblesVideoPlayer.css'; // Create this CSS file for styling

const TheIncrediblesVideoPlayer = ({ videoUrl, onBack }) => {
  ...
  return (
    <div className="incredibles-video-player">
      <video ref={videoRef} src={"/Videos/incredibles.mp4"} controls className="incredibles-video-element">
...
export default TheIncrediblesVideoPlayer;
