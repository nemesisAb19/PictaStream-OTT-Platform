...
import './TitliVideoPlayer.css'; // Create this CSS file for styling

const TitliVideoPlayer = ({ videoUrl, onBack }) => {
  ...
  return (
    <div className="titli-video-player">
      <video ref={videoRef} src={"/Videos/titli.mp4"} controls className="titli-video-element">
...
export default TitliVideoPlayer;
